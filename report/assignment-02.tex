...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{assignment-02/img/Diagrammi per IOT - MainTask.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\linewidth]{assignment-02/img/Diagrammi per IOT - Telemetry Task.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{assignment-02/img/Diagrammi per IOT - Temperature Check Task.png}
        \caption{diagramma degli stati di \textit{Telemetry task}}
